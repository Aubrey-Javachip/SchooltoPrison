...
this.cursors = this.input.keyboard.createCursorKeys();
	...
	this.label = this.add.text(80, 260, 'While at lunch a fight between your classmates break out' ,menuConfig).setInteractive();
    this.label = this.add.text(80, 280,'You decide to help de-escalate the fight',menuConfig).setInteractive();
