...
export default class Security2 extends Phaser.Scene{
    constructor(){
        super("security2Scene");
    }
    ...
    this.cursors = this.input.keyboard.createCursorKeys();
        ...
        this.label = this.add.text(100, 320, 'Security: Why are you late?',menuConfig).setInteractive();
       ...
       // this.typewriteText('You wake up in the morning to realize your alarm clock did not go off.\n You\'re late for schoool! Filled with panic, you rush out to get to class before security closes the school gate..');
        ...
        this.label2.on("pointerdown", () => {
            this.scene.start('securitygoodScene');
            //play student2.js
            }, this);
        this.typewriteText2('Explain why you\'re late');
